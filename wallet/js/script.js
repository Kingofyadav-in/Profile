...
function updateLogo() {
  ...
  const logoSrc = `/wallet/logo/${theme}-logo.png`;
  const logoSelectors = [
    "#siteLogo",
    "#personalLogo",
    "#authLogo",
  ...
  const groups = orderFooterGroups([
    ...
    },
    {
      ...
      links: [
        ...
        { href: "wallet.html", label: "HI Wallet", note: "Human identity wallet" },
        { href: "vault.html", label: "HI Vault", note: "Protected digital backup" },
        { href: "merchant.html", label: "Merchant", note: "Payment and merchant layer" },
        ...
        { href: "index.html", label: "Digital Coin", note: "Public coin movement page" },
        { href: "coin.html", label: "HI Coin", note: "Coin concept and roadmap" }
      ]
    },
    {
      title: "Identity",
