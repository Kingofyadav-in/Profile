...
- Name: site.spec.js >> Homepage >> loads on mobile without horizontal scroll
- Location: tests/e2e/site.spec.js:39:3

# Error details

```
Error: page.goto: net::ERR_INTERNET_DISCONNECTED at https://kingofyadav.in/
Call log:
