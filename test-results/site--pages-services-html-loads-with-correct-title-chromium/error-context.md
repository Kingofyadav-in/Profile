...
- Name: site.spec.js >> /pages/services.html loads with correct title
- Location: tests/e2e/site.spec.js:60:3

# Error details

```
Error: page.goto: net::ERR_INTERNET_DISCONNECTED at https://kingofyadav.in/pages/services.html
Call log:
  - navigating to "https://kingofyadav.in/pages/services.html", waiting until "load"
