...
- Name: site.spec.js >> /pages/login.html loads with correct title
- Location: tests/e2e/site.spec.js:60:3

# Error details

```
Error: page.goto: net::ERR_INTERNET_DISCONNECTED at https://kingofyadav.in/pages/login.html
Call log:
  - navigating to "https://kingofyadav.in/pages/login.html", waiting until "load"
