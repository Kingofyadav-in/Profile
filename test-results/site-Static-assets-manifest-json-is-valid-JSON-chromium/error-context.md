...
- Name: site.spec.js >> Static assets >> manifest.json is valid JSON
- Location: tests/e2e/site.spec.js:127:3

# Error details

```
Error: apiRequestContext.get: getaddrinfo EAI_AGAIN kingofyadav.in
Call log:
  - → GET https://kingofyadav.in/manifest.json
