...
- Name: site.spec.js >> /pages/about.html loads with correct title
- Location: tests/e2e/site.spec.js:60:3

# Error details

```
Error: page.goto: net::ERR_NAME_NOT_RESOLVED at https://kingofyadav.in/pages/about.html
Call log:
  - navigating to "https://kingofyadav.in/pages/about.html", waiting until "load"
