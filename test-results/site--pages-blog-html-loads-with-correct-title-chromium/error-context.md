...
- Name: site.spec.js >> /pages/blog.html loads with correct title
- Location: tests/e2e/site.spec.js:60:3

# Error details

```
Error: page.goto: net::ERR_INTERNET_DISCONNECTED at https://kingofyadav.in/pages/blog.html
Call log:
  - navigating to "https://kingofyadav.in/pages/blog.html", waiting until "load"
